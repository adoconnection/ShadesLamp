// Static data — programs library, marketplace catalog, device info

// ── Color helpers ──
// Each program has a "vibe" — a cover gradient + dominant LED color
const PROGRAMS_INSTALLED = [
  {
    id: 0,
    name: 'RGB Cycle',
...
const MARKETPLACE = [
  {
    ...
    name: 'Plasma Field',
    author: 'shaderkit',
    desc: 'Классическое плазменное поле, плавные переливы синусов',
    size: '7.4 KB',
    downloads: 12400,
    rating: 4.8,
    cover: { from: '#7C3AED', to: '#EC4899', via: '#3B82F6', angle: 120 },
    pulse: '#EC4899',
    category: 'Ambient',
    featured: true,
    paramCount: 5,
  },
  {
    ...
    name: 'Fireplace',
    author: 'cozy.lab',
    desc: 'Мерцающий камин — тёплые красно-оранжевые тона',
    size: '4.9 KB',
    downloads: 8650,
    rating: 4.9,
    cover: { from: '#7C2D12', to: '#FCD34D', via: '#EA580C', angle: 175 },
    pulse: '#EA580C',
    category: 'Ambient',
    featured: true,
    paramCount: 4,
  },
  {
    ...
    name: 'Matrix Rain',
    author: 'k.morov',
    desc: 'Падающие зелёные символы',
    size: '5.1 KB',
    downloads: 23100,
    rating: 4.7,
    cover: { from: '#022C22', to: '#10B981', via: '#064E3B', angle: 180 },
    pulse: '#10B981',
    category: 'Effects',
    featured: true,
    paramCount: 3,
  },
  {
    ...
    name: 'Tetris',
    author: 'pixel.games',
    desc: 'Классика — управление с телефона',
    size: '8.8 KB',
    downloads: 5400,
    rating: 4.6,
    cover: { from: '#1E1B4B', to: '#F59E0B', via: '#7C3AED', angle: 90 },
    pulse: '#F59E0B',
    category: 'Games',
    featured: false,
    paramCount: 4,
  },
  {
    ...
    author: 'audio.lab',
    desc: 'FFT-анализатор по микрофону, 16 полос',
    size: '6.3 KB',
    downloads: 9200,
    rating: 4.8,
    cover: { from: '#312E81', to: '#06B6D4', via: '#3B82F6', angle: 105 },
    pulse: '#06B6D4',
    category: 'Visualizers',
    featured: false,
    paramCount: 6,
  },
  {
    ...
    name: 'Snowfall',
    author: 'cozy.lab',
    desc: 'Падающий снег, мягкий синий',
    size: '3.8 KB',
    downloads: 4100,
    rating: 4.5,
    cover: { from: '#0C4A6E', to: '#E0F2FE', via: '#0EA5E9', angle: 200 },
    pulse: '#E0F2FE',
    category: 'Ambient',
    featured: false,
    paramCount: 3,
  },
  {
    ...
    name: 'Pong',
    author: 'pixel.games',
    desc: 'Двое играющих, тач-управление',
    size: '5.5 KB',
    downloads: 2300,
    rating: 4.3,
    cover: { from: '#0F172A', to: '#22D3EE', via: '#1E293B', angle: 120 },
    pulse: '#22D3EE',
    category: 'Games',
    featured: false,
    paramCount: 3,
  },
  {
    ...
    name: 'Pixel Clock',
    author: 'shaderkit',
    desc: 'Цифровые часы 16×32, разные шрифты',
    size: '9.1 KB',
    downloads: 18700,
    rating: 4.9,
    cover: { from: '#0A0A0A', to: '#F472B6', via: '#1F2937', angle: 145 },
    pulse: '#F472B6',
    category: 'Effects',
    featured: true,
    paramCount: 4,
...
const CATEGORIES = ['All', 'Effects', 'Ambient', 'Games', 'Visualizers'];
...
const DEVICE_INFO = {
  ...
  firmware: 'v0.4.1',
  matrix: '16 × 32',
  storage: { used: 31, total: 256 }, // KB
  uptime: '4d 12h',
  rssi: -52,
};

// Mock BLE devices for the connect screen
...
Object.assign(window, {
  PROGRAMS_INSTALLED, MARKETPLACE, CATEGORIES, DEVICE_INFO, NEARBY_DEVICES,
});
