...
/* ---- Sine/cosine (native), scaled to -127..127 to match prior table ---- */
static int isin(int angle) { return (int)(m_sin((float)angle * (6.28318530f / 256.0f)) * 127.0f); }
static int icos(int angle) { return (int)(m_cos((float)angle * (6.28318530f / 256.0f)) * 127.0f); }

/* ---- HSV to RGB (h,s,v in 0..255) — native ---- */
